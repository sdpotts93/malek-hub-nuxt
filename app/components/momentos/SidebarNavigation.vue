  ...
  <nav class="sidebar-nav">
    ...
    >
      ...
      <span class="sidebar-nav__icon">
        <!-- Design icon -->
        <svg v-if="item.id === 'diseno'" class="sidebar-nav__svg" width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Image/Archivo icon -->
        <svg v-else-if="item.id === 'archivos'" class="sidebar-nav__svg" width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else-if="item.id === 'marco'" class="sidebar-nav__svg" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_frame_mom_sidebar)">
          ...
          <defs>
            <clipPath id="clip0_frame_mom_sidebar">

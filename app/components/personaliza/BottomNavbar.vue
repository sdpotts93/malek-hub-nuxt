    ...
    <nav class="bottom-navbar">
      ...
      >
        <span class="bottom-navbar__icon">
          ...
          <!-- Text (texto) icon -->
          <svg v-else-if="item.id === 'texto'" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Margen icon -->
          <svg v-else-if="item.id === 'margen'" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
